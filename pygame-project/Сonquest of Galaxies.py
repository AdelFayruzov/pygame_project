...
pygame.display.set_caption("Покорение галактик")
icon = pygame.image.load("graphics/solar-system.png")
...
# Главное меню
def intro():
    button1 = pygame.image.load("buttons/button 01.png")
    button2 = pygame.image.load("buttons/button 02.png")
    button3 = pygame.image.load("buttons/button 03.png")
    button4 = pygame.image.load("buttons/button 04.png")
    ...
    button1hover = pygame.image.load("buttons/button1.png")
    button2hover = pygame.image.load("buttons/button2.png")
    button3hover = pygame.image.load("buttons/button3.png")
    button4hover = pygame.image.load("buttons/button4.png")
    ...
    introIMG = pygame.image.load("graphics/Game_Intro.png")
    ...
    while introBool:
        ...
        for event in pygame.event.get():
            if event.type == QUIT:
                pygame.quit()
                sys.exit()
            if event.type == MOUSEBUTTONDOWN and 130 <= x <= 448 and 150 <= y <= 250:
                introBool = False
                Gameplay()
            if event.type == MOUSEBUTTONDOWN and 285 <= x <= 545 and 483 <= y <= 558:
                introBool = False
                controls()
            if event.type == MOUSEBUTTONDOWN and 286 <= x <= 542 and 572 <= y <= 639:
                introBool = False
                highscores()
            if event.type == MOUSEBUTTONDOWN and 286 <= x <= 544 and 650 <= y <= 719:
                introBool = False
                about()

        SURF.blit(introIMG, (0, 0))
        if 130 <= x <= 448 and 150 <= y <= 250:
            SURF.blit(button1hover, (130, 150))
        else:
            SURF.blit(button1, (130, 150))

        if 285 <= x <= 545 and 483 <= y <= 558:
            SURF.blit(button3hover, (285, 490))
        else:
            SURF.blit(button2, (285, 490))

        if 286 <= x <= 542 and 572 <= y <= 639:
            SURF.blit(button2hover, (285, 490 + 70 + 10))
        else:
            SURF.blit(button3, (285, 490 + 70 + 10))

        if 286 <= x <= 544 and 650 <= y <= 719:
...
def highscores():
    ...
    highscoresIMG = pygame.image.load("graphics/Statistic.png")
...
# Меню Об игре
def about():
    aboutIMG = pygame.image.load("graphics/About.png")
...
def Gameplay():
    ...
    musicPlaying = True
    pygame.mixer.music.load("music/shuttle.ogg")
    pygame.mixer.music.play(-1, 0.0)
    boost = pygame.mixer.Sound("music/shuttleboodt.ogg")

    font = pygame.font.SysFont("Arial Black", 20)

    stars1 = pygame.image.load("background/SpaceStars1.png")
    stars2 = pygame.image.load("background/SpaceStars2.png")
    stars3 = pygame.image.load("background/SpaceStars3.png")
    stars4 = pygame.image.load("background/SpaceStars4.png")
    stars5 = pygame.image.load("background/SpaceStars5.png")
    stars6 = pygame.image.load("background/SpaceStars6.png")
    stars7 = pygame.image.load("background/SpaceStars7.png")
    stars8 = pygame.image.load("background/SpaceStars8.png")
    stars9 = pygame.image.load("background/SpaceStars9.png")
    stars10 = pygame.image.load("background/SpaceStars10.png")
    stars11 = pygame.image.load("background/SpaceStars11.png")
    stars12 = pygame.image.load("background/SpaceStars12.png")

    explosion = pygame.image.load("graphics/Explosion.png")
    lightexplosion = pygame.image.load("graphics/Light_Explosion.png")
    ...
    spaceshipIMG = pygame.image.load("graphics/Space_Shuttle.png")
    spaceshipIMG = pygame.transform.scale(spaceshipIMG, (140, 180))
    xObstacle, yObstacle = (40, 25)
    obstacle = []

    sateliteIMG = pygame.image.load("graphics/Satellite.png")
    sateliteIMG = pygame.transform.scale(sateliteIMG, (75, 75))
    asteroidIMG = pygame.image.load("graphics/Asteroid.png")
    asteroidIMG = pygame.transform.scale(asteroidIMG, (75, 75))
    flameIMG = pygame.image.load("graphics/Fire_Flame.png")
    flameIMG = pygame.transform.scale(flameIMG, (70, 180))
    lighterFlameIMG = pygame.image.load("graphics/Light_Flame.png")
    lighterFlameIMG = pygame.transform.scale(lighterFlameIMG, (70, 180))
    darkerFLameIMG = pygame.image.load("graphics/Dark_Flame.png")
    ...
    while GAME:
        ...
        LEVEL8 = 6500 <= j < 7500
        LEVEL9 = 7500 <= j < 8750
        LEVEL10 = 8750 <= j < 10000

        if LEVEL1 and levelstop1:
            level = 1
            kmh = 14000
            levelstop1 = False
        if LEVEL2 and levelstop2:
            level = 2
            kmh = 15000
            levelstop2 = False
        if LEVEL3 and levelstop3:
            level = 3
            kmh = 16000
            levelstop3 = False
        if LEVEL4 and levelstop4:
            level = 4
            kmh = 17000
            levelstop4 = False
        if LEVEL5 and levelstop5:
            level = 5
            kmh = 18000
            levelstop5 = False
        if LEVEL6 and levelstop6:
            level = 6
            kmh = 19000
            levelstop6 = False
        if LEVEL7 and levelstop7:
            level = 7
            kmh = 20000
            levelstop7 = False
        if LEVEL8 and levelstop8:
            level = 8
            kmh = 21000
            levelstop8 = False
        if LEVEL9 and levelstop9:
            level = 9
            kmh = 22000
            levelstop9 = False
        if LEVEL10 and levelstop10:
            level = 10
            kmh = 23000
            levelstop10 = False
        ...
        text = font.render("{0:n}".format(kmh) + " км/ч                                                  " + "Уровень: "
                           + str(level), True,
                           (255, 255, 255))
    ...
    explosionSound = pygame.mixer.Sound("music/Explosion+3.ogg")
    explosionSound2 = pygame.mixer.Sound("music/Explosion+6.ogg")
    gameOver = font2.render("Игра Окончена!", True, (255, 255, 255))
    menuInfo = font.render("Нажми ESC для выхода в главное меню", True, (135, 136, 156))
...
# Инициализация
def introAll():
    pygame.mixer.music.load("music/Main Intro.mp3")
